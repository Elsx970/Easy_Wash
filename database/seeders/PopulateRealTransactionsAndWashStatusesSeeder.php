...
class PopulateRealTransactionsAndWashStatusesSeeder extends Seeder
{
    /**
    ...
    public function run(): void
    {
        ...
        $this->command->info("✅ Transactions created: {$createdTransactions}");
        $this->command->info("✅ Wash Statuses created: {$createdWashStatuses}");
    }
}
